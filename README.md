# tf-atom-apigateway-stage-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-apigateway-stage-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-apigateway-stage-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS API Gateway Stage - creates a deployment stage.
...
|------|-------------|------|---------|:--------:|
| <a name="input_access_log_destination_arn"></a> [access\_log\_destination\_arn](#input\_access\_log\_destination\_arn) | ARN of the CloudWatch log group for access logs | `string` | n/a | yes |
| <a name="input_deployment_id"></a> [deployment\_id](#input\_deployment\_id) | ID of the deployment | `string` | n/a | yes |
| <a name="input_rest_api_id"></a> [rest\_api\_id](#input\_rest\_api\_id) | ID of the REST API | `string` | n/a | yes |
| <a name="input_access_log_format"></a> [access\_log\_format](#input\_access\_log\_format) | Format of the access logs (JSON recommended) | `string` | `"{\"requestId\":\"$context.requestId\",\"ip\":\"$context.identity.sourceIp\",\"caller\":\"$context.identity.caller\",\"user\":\"$context.identity.user\",\"requestTime\":\"$context.requestTime\",\"httpMethod\":\"$context.httpMethod\",\"resourcePath\":\"$context.resourcePath\",\"status\":\"$context.status\",\"protocol\":\"$context.protocol\",\"responseLength\":\"$context.responseLength\"}"` | no |
...
| <a name="input_stage_name"></a> [stage\_name](#input\_stage\_name) | Name of the stage | `string` | `"v1"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the stage |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether the module is enabled |
| <a name="output_execution_arn"></a> [execution\_arn](#output\_execution\_arn) | Execution ARN for the stage |
| <a name="output_id"></a> [id](#output\_id) | ID of the stage |
| <a name="output_invoke_url"></a> [invoke\_url](#output\_invoke\_url) | URL to invoke the API |
<!-- END_TF_DOCS -->
